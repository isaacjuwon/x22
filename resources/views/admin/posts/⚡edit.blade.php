...
<div class="mx-auto max-w-4xl space-y-6 p-4 sm:p-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-3">
            <x-ui.button
                ...
                icon="arrow-left"
            />
            <x-ui.heading level="h1" size="lg" class="truncate">{{ __('Edit Post') }}</x-ui.heading>
        </div>
    ...
    <form wire:submit="save" id="post-form" class="space-y-6">
        ...
        <x-ui.card class="p-4 sm:p-6 space-y-6">
            <div class="flex items-center gap-2 border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-2">
                <x-ui.icon name="globe-alt" class="w-5 h-5 text-neutral-400" />
                <x-ui.heading level="h2" size="sm" class="uppercase tracking-widest text-neutral-500 font-bold">
                    {{ __('SEO Settings') }}
                </x-ui.heading>
            </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div class="space-y-5">
                    <x-ui.field>
                        ...
                        <x-ui.textarea wire:model="metaDescription" rows="4" placeholder="{{ __('Max 160 characters...') }}" />
                        <x-ui.error name="metaDescription" />
                    </x-ui.field>

                    <x-ui.field>
                        <x-ui.label>{{ __('Legacy OG URL') }}</x-ui.label>
                ...
                <div class="space-y-5">
                    <x-ui.media.single
                        :label="__('Social Share Image')"
                        :preview-url="$this->currentSeoOgImageUrl"
                        :preview-alt="$title ?: __('SEO preview')"
