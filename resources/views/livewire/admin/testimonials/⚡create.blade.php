...
new #[Title('New Testimonial'), Layout('layouts::app')] class extends Component {
    ...
    public string $status = TestimonialStatus::Pending->value;
    ...
    public function save(): void
    {
        ...
        $this->dispatch('notify', type: 'success', content: __('Testimonial created.'));
...
<div class="mx-auto max-w-3xl space-y-6 p-6">
    ...
    <div class="flex items-center gap-3">
        <x-ui.button
            ...
            icon="arrow-left"
        />
        <x-ui.heading level="h1" size="lg">{{ __('New Testimonial') }}</x-ui.heading>
    </div>
