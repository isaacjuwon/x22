...
new #[Title('Add Team Member'), Layout('layouts::app')] class extends Component {
    ...
    public string $role = TeamMemberRole::Developer->value;

    #[Validate('required|in:active,inactive,pending')]
    public string $status = TeamMemberStatus::Active->value;
    ...
    public function save(): void
    {
        ...
        $this->dispatch('notify', type: 'success', content: __('Team member added.'));
...
<div class="mx-auto max-w-3xl space-y-6 p-6">
    ...
    <div class="flex items-center gap-3">
        <x-ui.button
            ...
            icon="arrow-left"
        />
        <x-ui.heading level="h1" size="lg">{{ __('Add Team Member') }}</x-ui.heading>
    </div>
