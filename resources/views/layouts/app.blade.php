...
<head>
    ...
    @if($pergamentFavicon)
        <link rel="icon" href="{{ \Illuminate\Support\Str::startsWith($pergamentFavicon, ['http://', 'https://', '//']) ? $pergamentFavicon : \App\Support\UrlGenerator::path(basename($pergamentFavicon)) }}">
    @endif
